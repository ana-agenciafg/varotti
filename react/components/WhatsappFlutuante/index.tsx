...
const WhatsappFlutuante = ({ 
    whatsappUrl = "https://api.whatsapp.com/send?phone=5511947022132",
    altDoLink = "Entre em contato através do WhatsApp"
...
WhatsappFlutuante.schema = {
    title: "WhatsApp Flutuante",
    type: "object",
    properties: {
      whatsappUrl: {
        title: "URL do WhatsApp",
        description: "Exemplo: https://api.whatsapp.com/send?phone=5511999999999",
        type: "string", 
        default: "https://api.whatsapp.com/send?phone=5511947022132"
      },
      altDoLink: {
        title: "Alt do link",
        type: "string", 
        default: "Entre em contato através do WhatsApp"
      }
    }
};